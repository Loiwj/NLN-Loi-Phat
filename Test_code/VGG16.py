...
def split_dataset(image_dir, output_dir, train_ratio=0.8):
    ...
    for class_folder in os.listdir(image_dir):
        ...
        # Create train and val subdirectories for each class
...
# Path to your image dataset (not split into train/val)
image_dir = '/kaggle/working/NLN-Loi-Phat/Dataset_2/'  # Change this to your dataset path

# Path where the split dataset will be stored
output_dir = '/kaggle/working/NLN-Loi-Phat/data'  # Change this to your output path

# Split dataset (80% train, 20% val)
split_dataset(image_dir, output_dir, train_ratio=0.8)

# Step 2: Define transformations for the training and validation data
data_transforms = {
...
# Path to your data folders (change this to the path where your images are stored)
...
# Step 3: Initialize the DenseNet121 model (pre-trained on ImageNet)
