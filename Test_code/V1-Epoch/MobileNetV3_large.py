...
# Initialize MobileNetV3-Large (pre-trained on ImageNet)
model = models.mobilenet_v3_large(pretrained=True)

# Modify the final layer to match the number of classes in your dataset
num_ftrs = model.classifier[3].in_features
model.classifier[3] = nn.Linear(num_ftrs, len(image_datasets['train'].classes))
...
torch.save(model.state_dict(), 'mobilenet_v3_large_finetuned.pth')
