...
# Function to split dataset into train/val (Same as before)
...
# Define transformations for the training and validation data (Same as before)
data_transforms = {
...
# Get dataset sizes (Same as before)
dataset_sizes = {x: len(image_datasets[x]) for x in ['train', 'val']}

# Initialize EfficientNet-B6 (pre-trained on ImageNet)
...
torch.save(model.state_dict(), 'efficientnet_b6_finetuned.pth')
