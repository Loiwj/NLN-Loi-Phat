...
for fold, (train_idx, val_idx) in enumerate(skf.split(np.zeros(len(targets)), targets)):
    ...
    # Combined model that takes the outputs of both EfficientNet and ResNet50
    class CombinedModel(nn.Module):
        def __init__(self, efficientnet, resnet50, num_classes):
